...
{{--                                            </a>--}}
                                            ...
                                            <form class="d-inline" action="{{ route('exams.destroy', $exam->id) }}" method="post" onsubmit="return confirm('Are you sure to delete this? Once deleted, It can not be undone.')">
                                                @csrf
                                                @method('delete')
