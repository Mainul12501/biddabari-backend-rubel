...
{{--                    <input type="text" class="form-control" id="dateTime" data-dtp="dtp_Nufud" name="available_at" placeholder="Available Date Time" />--}}
            ...
            <div class="d-none" id="typeVideo">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-6 select2-div d-none mt-2" id="classContentOf">
            ...
            <div class="d-none" id="typeAssignment">
                <div class="row mt-2">
                    ...
                    <div class="col-sm-6 mt-2">
                        <label for="">Start Time</label>
                        <input type="text" id="datetimepicker3" placeholder="Start Time" name="assignment_start_time" class="form-control" />
                    </div>
                    <div class="col-sm-6 mt-2">
                        <label for="">End Time</label>
