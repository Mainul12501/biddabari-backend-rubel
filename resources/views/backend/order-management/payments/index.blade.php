...
{{--                                        <a href="" data-blog-category-id="{{ $sslPayment->id }}" class="btn btn-sm btn-warning blog-category-edit-btn" title="Change Order Status">--}}
{{--                                            <i class="fa-solid fa-edit"></i>--}}
{{--                                        </a>--}}


{{--                                            <form class="d-inline" action="{{ route('exam-orders.destroy', $sslPayment->id) }}" method="post" >--}}
{{--                                                @csrf--}}
{{--                                                @method('delete')--}}
