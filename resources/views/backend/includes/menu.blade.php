            ...
            <ul class="side-menu">
                ...
                <li class="slide {{ request()->is('permission-categories*') || request()->is('permissions*')|| request()->is('roles*')|| request()->is('users') ? 'is-expanded' : '' }}">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('users.index') }}" class="slide-item {{ request()->is('users') || request()->is('users*') ? 'active' : '' }}">User Role</a></li>
                    </ul>
                </li>
...
{{--                        <li><a href="{{ route('subscription-orders.index') }}" class="slide-item {{ request()->is('subscription-orders') || request()->is('subscription-orders*') ? 'active' : '' }}"> Subscription Order</a></li>--}}
