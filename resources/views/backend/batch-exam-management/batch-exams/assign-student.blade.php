                        ...
                        <div class="card card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="number" name="total_amount" readonly class="form-control" value="{{ \App\helper\ViewHelper::getModelPriceAfterDiscount('batch_exam', $batchExam->id) }}" placeholder="Total Amount" />
