            ...
            <nav class="navbar navbar-expand-md navbar-light ">
                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="{{ route('front.all-blogs') }}" class="nav-link {{ request()->is('all-blogs') || request()->is('blog-details/*') ? 'active' : '' }}">ব্লগ</a></li>
                        <li class="nav-item"><a href="{{ route('front.all-products') }}" class="nav-link {{ request()->is('all-products') || request()->is('product-details/*') ? 'active' : '' }}">বই</a></li>
{{--                        @if(auth()->check())--}}
                        ...
                        <div class="optional-item dropdown">
                            ...
                            @if(auth()->check())
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <div class="dropdown-item"><a href="{{ route('front.all-job-circulars') }}" class="text-dark f-s-20">Job Circulars</a></div>
