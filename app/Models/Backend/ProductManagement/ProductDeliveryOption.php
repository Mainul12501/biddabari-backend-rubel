...
class ProductDeliveryOption extends Model
{
    ...
    public static function saveOrUpdateProductDeliveryOptions ($request, $id = null)
    {
        static::updateOrCreate(['id' => $id], [
            ...
            'image'         => imageUpload($request->file('image'), 'product-management/product-delivery-options/', 'product-delivery-options', '400', '400', (isset($id) ? ProductAuthor::find($id)->image : null)),
